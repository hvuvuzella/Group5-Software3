...
# Sending request to endpoint to get information about the booking
...
def run():
    ...
    if stylist_or_customer == "c":
        ...
        if registered_user == "n":
            ...
            print(f"Congratulations! You are registered with an id {client_id['customer_id']}. Use this id to make, update and delete your appointments.")
